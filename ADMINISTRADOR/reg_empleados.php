...
$conexion = new mysqli("localhost", "root", "", "bd_parkingsq");
    ...
    $sql = "SELECT * FROM turnos_empleados LIMIT $offset, $registrosPorPagina";
    $resultado = $conexion->query($sql);
    
    // Consulta SQL para obtener el número total de registros
    $totalRegistros = $conexion->query("SELECT COUNT(*) as total FROM turnos_empleados")->fetch_assoc()['total'];
...
if ($resultado->num_rows > -1) {
    ...
    echo "<h2 align='center'>REGISTRO DE EMPLEADOS</h2>";
    echo "</div>";
...
<div class="pagination">
        ...
        for ($i = 1; $i <= $numTotalPaginas; $i++) {
            ...
            echo "<a class='$claseActiva' href='reg_empleados.php?pagina=$i'>$i</a>";
        }
        ?>
</div>
<br>
