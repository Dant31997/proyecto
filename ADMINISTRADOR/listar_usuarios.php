...
<head>
    ...
    <style>
        html{
            background: linear-gradient(to bottom, rgb(177, 176, 176),70%, #ffffff ); margin: 0; height: 100vh; display: flex; justify-content: center; align-items: center; 
...
<body>
    ...
    if ($resultado->num_rows > 0) {
        echo "<table border='1'>";
        echo "<th style=width:150px;>Login</th><th>Rol</th><th style=width:250px;>Nombre de la persona</th><th style=width:250px;>Contraseña</th><th style=width:200px>Acciones</th></tr>";
        while ($fila = $resultado->fetch_assoc()) {
            ...
            echo "<td><a href='editar_listado.php?id=" . $fila['id'] . "&login=" . $fila['login'] ."&nombre=" . $fila['nombre'] . "&rol=" . $fila['rol'] . "'><img src='imagenes/editar.png' /></a><h>--</h><a href='eliminar_usuario.php?id=" . $fila['id'] . "'><img src='imagenes/eliminar.png' /></a></td>";
            echo "</tr>";
        }
        echo "</table>";
