...
if ($resultado->num_rows > 0) {
    ...
    while ($fila = $resultado->fetch_assoc()) {
        ...
        echo "<td><a href='editar_espacio.php?cod_espacio=" . $fila['cod_espacio'] . "&nom_espacio=" . $fila['nom_espacio'] ."&placa=" . $fila['placa']. "&estado_espacio=" . $fila['estado_espacio'] . "&hora_llegada=" . $fila['hora_llegada']. "&hora_salida=" . $fila['hora_salida'] . "&fecha=" .$fila['fecha'] ."&cobro=" . $fila['cobro'] ."'><img src='imagenes/editar.png' /></a></td>";
        echo "</tr>";
    }
...
<?php
    $paginavolver = "";
        if (isset($_POST['inv'])) {
            $paginavolver = "http://localhost/proyecto/SUPERVISOR/supervisor.php";
        }
    ?>
    <a class ="regresar" href="supervisor.php">Regresar</a>
